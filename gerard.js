...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    particlesJS("particles-js", {
        particles: {
            ...
            {
                value: 400, density:
                    { enable: true, value_area: 3787.908679834909 }
            },
            color: { value: "#0e00ff" },
            shape: {
                type: "polygon",
            ...
            detect_on: "window", events: {
                onhover: { enable: false, mode: "repulse" }, onclick: { enable: false, mode: "bubble" }, resize: true
            },
            modes: {
                grab: { distance: 400, line_linked: { opacity: 0.5 } }, bubble: {
                    distance: 400, size: 4, duration: 0.3, opacity: 1,
                    speed: 3
